...
```sh
./build/wireless_04_udp_livestream <ble_mac> <this_host_ip> [udp_port] [num_frames]
./build/wireless_04_udp_livestream AA:BB:CC:DD:EE:FF 192.168.1.50
```
