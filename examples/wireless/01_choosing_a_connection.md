---
title: "Choosing a connection (wireless)"
...
```sh
./build/wireless_01_choosing_a_connection                    # USB
./build/wireless_01_choosing_a_connection AA:BB:CC:DD:EE:FF   # Bluetooth
```
...
A line stating which transport connected and the M1's current WiFi association.
