---
title: "WiFi provisioning (wireless)"
...
```cpp
status = device.wifi_add(ssid, psk, country);
...
...
./build/wireless_03_wifi_provisioning "MySSID" "MyPassword" US AA:BB:CC:DD:EE:FF   # over BLE
```
