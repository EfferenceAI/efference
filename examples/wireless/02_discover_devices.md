---
title: "Discover devices (wireless)"
...
```sh
./build/wireless_02_discover_devices          # 3 s BLE scan
./build/wireless_02_discover_devices 6000     # 6 s BLE scan
```

## Expected output

One line per device with its transport and identifiers, then a total count.
