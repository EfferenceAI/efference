---
title: "OTA sideload"
description: "Update the firmware from a local .eff over USB, no network."
---
...
ERROR_CODE ec = device.update(eff, [](const UpdateStatus& s) {
    std::cout << "  " << to_string(s.state);          // UPLOADING/DOWNLOADING/VERIFYING/READY_TO_APPLY/APPLYING/REBOOTING
...
./build/ota_sideload path/to/update.eff
```
