...
```cpp
ec = device.upload_recording(name, url);   // WIFI_NOT_CONNECTED if not on WiFi
```
...
./build/record_and_upload AA:BB:CC:DD:EE:FF "https://bucket.s3.amazonaws.com/key?X-Amz-..."

# a plain HTTP receiver on your network
./build/record_and_upload AA:BB:CC:DD:EE:FF "http://192.168.1.50:8098/upload.mcap"
```
